...
<body>
	...
	<form action="/AspirePositivity/r" method="POST">
		<table align="center" cellpadding="10">
			...
			<tr>
				<td>Middle Name</td>
				<td><input type="text" name="middleName" maxlength="30" /> (max
					30 characters a-z and A-Z)</td>
			</tr>
			<tr>
				<td>Last Name</td>
...
- See more at:
http://www.javawebtutor.com/articles/hibernate/mvc-appliction-using-servlet-jsp-and-hibernate.php#sthash.ZSCJtCIL.dpuf
